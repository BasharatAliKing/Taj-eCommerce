...
const Home = () => {
  ...
  <g fill="#f0d200">
    ...
    <polygon points="1080,0 1140,0 1180,100 1120,100" />
     ...
     <section className="relative h-[120vh] bg-cover bg-center bg-[url(/food-to-make.jpg)]">
         <img src="/british-asian-kitchen.png" className='absolute -top-25 left-20 z-10' width="15%" alt="" />
         <img src="/stars.svg" className='absolute -top-5 right-20 z-10' width="6%" alt="" />
         <div className="absolute inset-0 bg-[#221b4b7a] bg-opacity-40 flex flex-col justify-center items-center text-center text-white px-6">
           ...
           <img src="/yum-yum.png" width="20%" className='mr-auto ml-[20%]' alt="" />
         </div>
       </section>
      {/* food-Menus */}
  ...
  <img src="/homemade.png" className="" alt="" />
       ...
       <div className="container w-full flex flex-col gap-10">
        ...
        <p className='md:w-[50%] text-base text-white font-semibold'>If variety is the spice of life…we’re pretty hot! At MyLahore you’ll enjoy traditional tastes with a modern twist (and a personal touch) as we get creative with the finest, freshest ingredients. Tuck into our 100% halal choices below:</p>
        <div className="flex gap-5 md:w-[50%]">
            <button className='bg-[#FFD300] p-5 text-white hover:animate-scl font-medium text-base w-full rounded-md'>MAIN MENU</button>
            <button className='bg-[#FFD300] p-5 text-white hover:animate-scl font-medium text-base w-full rounded-md'>CATERING</button>
        </div>
       </div>
    </div>
     ...
     <div className="relative  bg-cover bg-center bg-[url(/button-pattern-pink.png)]">
        ...
        <div className="container flex ">
           ...
           <div className="flex flex-col gap-5 md:w-1/2 my-auto">
             <p className='text-base text-white font-semibold'>Save money and enjoy more with MyLahore Rewards – sign up today!</p>
             <p className='text-base text-white font-semibold'>Our huuugely rewarding scheme offers you 10% credit on the value of your restaurant order to use on a future date! So every £10 spent earns you £1 worth of credit! For example, spend £50 and get £5 credit to use later!</p>
             <p className='text-base text-white font-semibold'>MyLahore Rewards is available for both dine-in and collection orders in all our stores, as well as telephone delivery orders at our Bradford Delivery store, though not for online delivery orders via UberEats.</p>
             <p className='text-base text-white font-semibold underline'>Terms Apply!</p>
             <hr />
             <p className='text-base text-white font-semibold'>Say hello to our refreshed App! Rewards, perks & the MyLahore world at your fingertips.</p>
